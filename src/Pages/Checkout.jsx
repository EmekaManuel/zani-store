...
const Checkout = () => {
  ...
  return (
	...
	l1.454-9.225L9.614,7.699z"
          ...
          <button className="bg-gray-200 p-4 m-2 bg-transparent hover:bg-gray-300 font-semibold hover:text-white py-2 px-10 border border-transparent">
            ...
            >
              <path
                fill="#5F6368"
                d="M37.8,19.7V29h-3V6h7.8c1.9,0,3.7,0.7,5.1,2c1.4,1.2,2.1,3,2.1,4.9c0,1.9-0.7,3.6-2.1,4.9c-1.4,1.3-3.1,2-5.1,2
	L37.8,19.7L37.8,19.7z M37.8,8.8v8h5c1.1,0,2.2-0.4,2.9-1.2c1.6-1.5,1.6-4,0.1-5.5c0,0-0.1-0.1-0.1-0.1c-0.8-0.8-1.8-1.3-2.9-1.2
	L37.8,8.8L37.8,8.8z"
              />
              <path
                fill="#5F6368"
                d="M56.7,12.8c2.2,0,3.9,0.6,5.2,1.8s1.9,2.8,1.9,4.8V29H61v-2.2h-0.1c-1.2,1.8-2.9,2.7-4.9,2.7
	...
	c-1.2,0-2.2,0.3-3,0.9C53.3,22.6,52.9,23.3,52.9,24.2z"
              ...
              <path
                fill="#34A853"
                d="M13.2,30.6c3.6,0,6.6-1.2,8.8-3.2l-4.3-3.3c-1.2,0.8-2.7,1.3-4.5,1.3c-3.4,0-6.4-2.3-7.4-5.5H1.4v3.4
	C3.7,27.8,8.2,30.6,13.2,30.6z"
              ...
              <path
                fill="#EA4335"
                d="M13.2,9.4c1.9,0,3.7,0.7,5.1,2l0,0l3.8-3.8c-2.4-2.2-5.6-3.5-8.8-3.4c-5,0-9.6,2.8-11.8,7.3l4.4,3.4
	C6.8,11.7,9.8,9.4,13.2,9.4z"
        ...
        <div className="contact-information">
          ...
          <small className="md:float-right">
        ...
        <div className="shipping-address mt-10">
          ...
          <form className="mt-5">
            ...
            <div className="md:flex md:justify-between">
             ...
             <Link to = "/cart">
             <button className="border-2 my-2 text-black bg-white hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium text-sm w-full sm:w-auto px-10 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 border-gray-900">
                Return to Cart
              </button>
             </Link>
           
              <button className="border-2 my-2 border-black text-white bg-black hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium text-sm w-full sm:w-auto px-10 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                ...
                <>
                  <div className="cart-item flex flex-col mb-10 md:flex-row">
                    <LazyLoadImage
                      src={Logo}
                      alt="item"
                      className="h-max w-max md:h-max md:w-max md:mr-10"
                    />

                    <div className="item-details mr-auto">
                      <h3>{cartItem.name}</h3>
                      <h5>category: {cartItem.category}</h5>
                    </div>
          ...
          <>
            ...
            <div className="discount md:flex md:grid-cols-2">
              <input
                type="text"
                id="discount"
                className="mb-2 md:mr-2 bg-white border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Gift card or discount code"
              />
              <button className="mb-2 md:mx-2 border-2 border-black text-white bg-black hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium text-sm w-full sm:w-auto px-10 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Apply
              </button>
            </div>
            ...
            <div className="subtotal flex">
              ...
              <p className="ml-auto"> {dollarUSlocale.format(totalAmount)}</p>
            </div>
